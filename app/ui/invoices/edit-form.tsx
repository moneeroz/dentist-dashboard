...
import { PatientField, DoctorField, InvoiceForm } from '@/app/lib/definitions';
import {
  CheckIcon,
  ClockIcon,
  CurrencyDollarIcon,
  ...
  return (
    <form action={dispatch}>
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <Select
              ...
              defaultInputValue={invoice.patient_id}
            />
          </div>
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              defaultValue={invoice.doctor_id}
      ...
      <div className="mt-6 flex justify-end gap-4">
        ...
        <Button type="submit">تعديل الفاتورة</Button>
      </div>
    </form>
  );
}
